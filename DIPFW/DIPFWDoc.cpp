...
BEGIN_MESSAGE_MAP(CDIPFWDoc, CDocument)	
	...
	ON_COMMAND(ID_POINTPROCESSING_HW1, &CDIPFWDoc::OnPointprocessingHw1)
	ON_COMMAND(ID_POINTPROCESSING_1DOT2, &CDIPFWDoc::OnPointprocessing1dot2)
END_MESSAGE_MAP()
...
void CDIPFWDoc::OnPointprocessingHw1()
{
...
void CDIPFWDoc::OnPointprocessing1dot2()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	int i, j;
